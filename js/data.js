...
const npcData = [
    ...
    { name: "해무사승려", x: -5728, y: 64, z: 3441, quest: "해무사퀘스트:기록서확인(1~6), 기록서1 -5640, 177, 3340, 기록서2 -5625, 149, 3432, 기록서3 -5555, 90, 3405, 기록서4 -5770, 140, 3332, 기록서5 -5749, 124, 3215, 기록서6 -5578, 174, 3275", file: "haemusa.png" },
