...
const huntingGrounds = [
    ...
    { name: "멸문", lv: "40~50", monsters: "뱀(lv.40), 청사(lv.45), 적사(lv.50)", memo: "*구렁이 출현(파력검법), [히든]호리병을 찾아서(수상한포탈)", records: [{ n:'수상한포탈', x: 3730, y: 129, z: -2591}],  file: "map4.png", x: 3858, y: 131, z: -2635, x: 3730, y: 129, z: -2591 },
